...
/**
 * RadgroupcheckExtSearch represents the model behind the search form of `app\models\RadgroupcheckExt`.
 */
class RadgroupcheckExtSearch extends RadgroupcheckExt
{
    /**
     * {@inheritdoc}
     */
